...
<cfif toptypestatuskind eq 'Primary' > 
       ...
       <cfset typeName = '<span style="font-weight:bold;background-color:##fff;padding: 5px 10px;text-align:center;margin-top:2em;width:100%;display:block;float: right;">#twotypes# </span>'>
...
<cfelse>
 ...
 <div style="padding: 0 15px">
        ...
        <div class="col-md-6">
                <cfif isDefined("cited_as") and len(cited_as) gt 0>
                    <cfif toptypestatuskind eq 'Primary' >
       					<div class="card flex-md-row box-shadow h-md-250" style="border: none;background-color: transparent;">
					</cfif>
     			    <cfif toptypestatuskind eq 'Secondary' >
        ...
        <div class="card-body d-flex flex-column align-items-start">
				...
				<div style="font-size:1.2em"> <strong class="d-inline-block mb-2">#collection#&nbsp;#cat_num#</strong></div>
				     <div class="mb-0"> 
				          <a class="text-dark font-italic" href="##" style="font-size: 20px;font-weight: 700;">#scientific_name#</a> #author_text#
				     </div>
				<div class="mb-1 text-muted" style="max-width: 400px;">#partString#</div>
       <div class="mb-1" style="margin-top: 1em;">#collectors#</div>
        </div>
                <cfif isDefined("cited_as") and len(cited_as) gt 0>
                      <cfif toptypestatuskind eq 'Primary' >
                   ...
                   <cfif isDefined("cited_as") and len(cited_as) gt 0>
                    ...
                    <div class="card-body d-flex flex-column align-items-start">
                        ...
                        <cfif len(verbatim_date) gt 0>
                            <div class="mb-2 text-muted" style="margin-top:.5em;">#verbatim_date#</div>  
                        <cfelse>      
                            <div class="mb-2 text-muted" style="margin-top: .5em;">#began_date# - #ended_date#</div>                   
                        </cfif>
                        <p class="card-text mb-1" style="font-size: 16px;margin-top: .5em;">#higher_geog#</p>
                        <a href="##" style="font-size: 13px;margin-top: 0em;display: block;">Berkeley Mapper</a> 
                    </div>
                    <img class="card-img-right flex-auto d-none d-md-block z-depth-2" style="padding: 16px;width: 150px;height: 150px;" src="/redesign/includes/images/locality.jpg" alt="Card image cap"> 
            </div>
            </div>
        </div>
