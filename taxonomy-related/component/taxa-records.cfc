...
<cfset listColumns ="taxon_name_id,scientific_name,phylclass,suborder,family,subfamily,genus,species" />
<cfif isDefined("searchText") and len(searchText) gt 0>
<cfquery name="qryLoc" datasource="uam_god">
select #listColumns# from taxonomy
WHERE CONTAINS(taxon_name_id, <cfqueryparam cfsqltype="CF_SQL_TEXT" value="#searchText#">, 1) > 0
</cfquery>
<cfelse>
