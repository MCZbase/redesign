...
<cfoutput>
	...
	<cfheader name="Location" value="/redesign/specimens/SpecimenDetailBody.cfm?collection_object_id=#collection_object_id#">
	<cfset guid = c.GUID>
	<!---<cfabort>--->
</cfoutput>
</cfif>
<cfif isdefined("guid")>
<cfif cgi.script_name contains "/redesign/specimens/SpecimenDetail.cfm">
	<cfheader statuscode="301" statustext="Moved permanently">
...
<script language="javascript" type="text/javascript">
        ...
        <form name="incPg" method="post" action="/redesign/specimens/SpecimenDetail.cfm">
...
<cfinclude template="/redesign/specimens/SpecimenDetailBody.cfm">
