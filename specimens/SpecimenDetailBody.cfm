...
<cfoutput>
    ...
    <cfif oneOfUs is 0 and cgi.CF_TEMPLATE_PATH contains "/redesign/SpecimenDetailBody.cfm">
...
function activaTab(tab){
  $('.nav-tabs a[href="##' + tab + '"]').tab('show');
    ...
    <cfif oneOfUs is 1>
        <form name="editStuffLinks" method="post" action="/redesign/SpecimenDetail.cfm">
...
<form name="newPart" method="post" action="SpecimenDetailBody.cfm">
        ...
        <cfif len(relns.biol_indiv_relationship) gt 0 >
            <div class="card">
                ...
                <ul class="list-group list-group-flush" style="padding-left: 5px;">
                    <li class="list-group-item">
                        <cfloop query="relns">
                            #biol_indiv_relationship# <a href="/redesign/SpecimenDetail.cfm?collection_object_id=#related_coll_object_id#" target="_top"> #related_collection# #related_cat_num# </a>
                            <cfif len(relns.biol_indiv_relation_remarks) gt 0>
                                (Remark: #biol_indiv_relation_remarks#)
                            </cfif>
                        </cfloop>
                        <cfif len(relns.biol_indiv_relationship) gt 0>
                            <a href="/redesign/Specimens.cfm?collection_object_id=#valuelist(relns.related_coll_object_id)#" target="_top">(Specimens List)</a>
                        </cfif>
                    </li>
                </ul>
            </div>
