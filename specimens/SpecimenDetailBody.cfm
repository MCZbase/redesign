		...
		<cfif media.recordcount gt 0>
			...
			<div class="card  card-primary bg-light text-left">
				<div class="card-header">
					...
					<button type="button" class="popperbtn detail-edit-cell float-right py-0 px-2 fs-14 border-dk-gray" onClick="$('##dialog-form').dialog('open'); setupNewLocality(#locality_id#);">Edit</button>
				</div>
