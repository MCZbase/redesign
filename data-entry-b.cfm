...
<script type='text/javascript' src='/redesign/includes/DEAjax.js'></script>
<script type='text/javascript' language="javascript" src='/redesign/includes/internalAjax.js'></script>
...
<cfif action is "editEnterData">
    ...
    <cfoutput> 
        ...
        <cfif collection_object_id GT 14>
    ...
    </cfoutput> <cfoutput query="data">
        <cfquery name="ctInst" datasource="uam_god">
        ...
        <cfquery name="ctnature" datasource="uam_god">
			select nature_of_id from ctnature_of_id order by nature_of_id
		</cfquery>
        <cfquery name="ctunits" datasource="uam_god">
        ...
        <!-------->
        <cfquery name="ctAttributeType" datasource="uam_god">
        ...
        <cfquery name="ctgeology_attribute" datasource="uam_god">
			select geology_attribute from ctgeology_attribute order by geology_attribute
		</cfquery>
        <cfquery name="ctCodes" datasource="uam_god">
			select
				attribute_type,
				value_code_table,
				units_code_table
        ...
        <cfset sql = "select collection_object_id from bulkloader where collection_object_id > 14">
        <cfif ImAGod is "no">
        ...
        <div class="container-fluid">
            <div class="form-group row">
                <div class="col-md-12">
                <h3> Data Entry</h3>
                <form name="dataEntry" class="form-inline" method="post" action="/redesign/data-entry.cfm" onsubmit="return cleanup(); return noEnter();" id="dataEntry">
                    <input type="hidden" name="action" value="" id="action">
                    <input type="hidden" name="nothing" value="" id="nothing"/>
                    <input type="hidden" name="uamgod" value="#uamgod#" id="ImAGod">
                    ...
                    <div class="col-12 my-1">
                        <div id="loadedMsgDiv" class="alert alert-warning">#loadedMsg#</div>
                    </div>
                    <div class="py-1 col-12"
                            <cfif collection_cde is "Mala">style="background-color: ##cd9917;"</cfif>
                            <cfif collection_cde is "IZ">style="background-color: ##cd991c;"</cfif>
                            <cfif collection_cde is "Mamm">style="background-color: ##eff2a4;overflow:hidden;"</cfif>
                            <cfif collection_cde is "Ich">style="background-color: ##98c9eb;"</cfif>
                            <cfif collection_cde is "Orn">style="background-color: ##e68250;"</cfif>
                            <cfif collection_cde is "IP">style="background-color: ##b8a4bc"</cfif>
                            <cfif collection_cde is "VP">style="background-color: ##b9b69e;"</cfif>
                            <cfif collection_cde is "Herp">style="background-color: ##92a462;"</cfif>
                            <cfif collection_cde is "Cryo">style="background-color: ##cbd9ee;"</cfif>
                            <cfif collection_cde is "Ent">style="background-color: ##eedecb;"</cfif>
                            <cfif collection_cde is "MCZ">style="background-color: ##a5acbf"</cfif>
                            <cfif collection_cde is "SC">style="background-color: ##c8bee8;"</cfif>>
                        <ul class="float-left list-group list-group-horizontal" style="flex-direction: row; vertical-align: bottom;">
                            <li class="list-group-item" style="font-size: 25px;margin-top: 4px;">
                                <cfif len(#loadedMsg#)gt 0>
                                    FIX
                                    <cfelse>
                                    #ucase(pMode)#
                            ...
                            <li class="list-group-item">
                                <label class="float-left" style="display: inline;margin-top:5px;"><b>#institution_acronym#:#collection_cde#:</b> <span id="catNumLbl" class="f11a">Cat##</span></label>
                                <input type="text" name="cat_num" value="#cat_num#" title="CAT_NUM" size="11" id="cat_num"  class="float-left" style="display: inline;">
                            </li>
                            <li class="list-group-item">
                                <cfif isdefined("session.CustomOtherIdentifier") and len(#session.CustomOtherIdentifier#) gt 0>
                                    <div id="d_other_id_num_type_5"> <span>#session.CustomOtherIdentifier#</span>
                            ...
                            <li class="list-group-item">
                                <label class="float-left" style="display: inline;margin-top:5px;">Accn: </label>
                                <input type="text" name="accn" title="ACCN" value="#accn#" size="9" class="reqdClr float-left" id="accn" onchange="isGoodAccn();" style="display: inline;">
                            </li>
                            <li class="list-group-item" style="padding-top: 10px;">
                                <cfif isdefined("session.CustomOtherIdentifier") and len(#session.CustomOtherIdentifier#) gt 0>
                                </cfif>
                                <input type="hidden" name="mask_record" value="0"/>
                                <input type="checkbox" name="mask_record" value="1" class="float-left" style="display:inline;margin-top: 5px;"<cfif #mask_record# EQ "1">checked</cfif>>
                                mask record
                                </input>
                            </li>
                        </ul>
                    ...
                    <div class="col-auto my-1">
                        <cfloop from="1" to="1" index="i">
                            <select name="collector_role_#i#" title="COLLECTOR_ROLE_X" id="collector_role_#i#" class="custom-select mr-md-2 mt-0">
                            ...
                            <input title="COLLECTOR_AGENT_X" type="text" class="form-control mb-2 mr-sm-2 mt-2" name="collector_agent_#i#" value="#evaluate("data.collector_agent_" & i)#" id="collector_agent_#i#"
			onchange="getAgent('nothing',this.id,'dataEntry',this.value);" onkeypress="return noenter(event);">
                        </cfloop>
                    </div>
                    <div class="col-auto my-1">
                        <cfloop from="1" to="1" index="i">
                            <select name="other_id_num_type_#i#" title="OTHER_ID_NUM_TYPE_X" id="other_id_num_type_#i#" class="custom-select mr-md-2 mt-0"
				onChange="dataEntry.other_id_num_#i#.focus();">
                                <option selected>Choose Other ID Type...</option>
                                <cfloop query="ctOtherIdType">
                                    <option value="#other_id_type#">#other_id_type#</option>
                                </cfloop>
                            </select>
                            <input type="text" class="form-control mb-2 mr-sm-2 mt-2" name="other_id_num_#i#" placeholder="Other ID" title="OTHER_ID_NUM_X" value="#evaluate("data.other_id_num_" & i)#" id="other_id_num_#i#">
                        </cfloop>
                    </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-auto my-1">
                            <label for="scientific_name" class="ml-4">Scientific Name</label>
                            <input type="text" class="form-control mr-sm-2 ml-4" title="TAXON_NAME" name="taxon_name" value="#taxon_name#" id="taxon_name" onchange="taxaPickOptional('nothing',this.id,'dataEntry',this.value)">
                        </div>
                        
                        <div class="col-auto my-1">
                            <label for="scientific_name" class="ml-4">ID By</label>
                            <input type="text" class="form-control mr-sm-2 ml-4" title="ID_MADE_BY_AGENT" name="id_made_by_agent" value="#id_made_by_agent#" id="id_made_by_agent" onchange="getAgent('nothing',this.id,'dataEntry',this.value)" onkeypress="return noenter(event);">
                        </div>
                        
                         <div class="col-auto my-1">
                            <label for="nature_of_id" class="ml-4">Nature of ID</label>
                            <select name="nature_of_id" id="NATURE_OF_ID" title="NATURE_OF_ID" class="custom-select mr-md-2 mt-0 ml-4">
                        <cfloop query="ctnature">
                            <option <cfif data.nature_of_id is ctnature.nature_of_id> selected="selected" </cfif>
                             ...
                             <div class="col-auto my-1">
                            <label for="made_date" class="ml-4">Date of ID</label>
                            <input type="text" name="made_date" class="form-control ml-4" value="#made_date#" id="made_date" title="MADE_DATE">
                        </div>
                             <div class="col-auto mb-1 mt-0">
                            <label for="scientific_name" class="ml-4">ID Remark</label>
                           <input type="text" name="identification_remarks" class="form-control ml-4" title="IDENTIFICATION_REMARKS" value="#identification_remarks#" id="identification_remarks" size="60">
                        </div>
        ...
        <span>Spec&nbsp;Locality&nbsp;</span>
        <input type="text" name="spec_locality" title="SPEC_LOCALITY" class="reqdClr"
									id="spec_locality"	value="#spec_locality#" size="75">
        <span>Verbatim Locality</span>
        <input type="text"  name="verbatim_locality"
									class="reqdClr" size="75"
									id="verbatim_locality" title="VERBATIM_LOCALITY" value="#verbatim_locality#">
        <span>Verbatim Date</span>
        <input type="text" name="verbatim_date" title="VERBATIM_DATE" class="reqdClr" value="#verbatim_date#" id="verbatim_date" size="14">
        <span class="infoLink"
									onClick="copyVerbatim($('##verbatim_date').val());"> >> </span> <span class="f11a">Begin</span>
        <input type="text" name="began_date" class="reqdClr" title="BEGAN_DATE" value="#began_date#" id="began_date" size="10">
        <span class="infoLink" onclick="copyAllDates('began_date');">Copy2All</span> <span class="f11a">End</span>
        <input type="text" name="ended_date" title="ENDED_DATE" class="reqdClr" value="#ended_date#" id="ended_date" size="10">
        <span class="infoLink" onclick="copyAllDates('ended_date');">Copy2All</span> <span class="f11a">Collecting Time</span>
        ...
        <tr>
            ...
            <td><table>
                    <tr>
                        <td><input type="text" name="collecting_method" value="#collecting_method#" title="COLLECTING_METHOD" id="collecting_method"></td>
                        <td align="right"><span class="f11a">Collecting Source</span></td>
                        <td><cfif len(collecting_source) gt 0>
        ...
        <tr id="d_habitat_desc">
            ...
            <td><input type="text" name="habitat_desc" title="HABITAT_DESC" size="50" id="habitat_desc" value="#habitat_desc#"></td>
        </tr>
        <tr id="d_associated_species">
            <td align="right"><span class="f11a">Associated&nbsp;Species</span></td>
            <td><input type="text" title="ASSOCIATED_SPECIES" name="associated_species" size="75" id="associated_species" value="#associated_species#"></td>
        </tr>
        <tr id="d_coll_object_habitat">
            <td align="right"><span class="f11a">Microhabitat</span></td>
            <td><input type="text" title="COLL_OBJECT_HABITAT" name="coll_object_habitat" size="75" id="coll_object_habitat" value="#coll_object_habitat#"></td>
        </tr>
        <tr>
            <td align="right"><span class="f11a">Verbatim Coordinates</span></td>
            <td><input type="text" title="verbatimcoordinates" name="verbatimcoordinates" size="75" id="verbatimcoordinates" value="#verbatimcoordinates#">
                <span class="f11a">(summary as given)</span></td>
        </tr>
        ...
        <td><input type="text" title="verbatimLatitude" name="verbatimlatitude" size="14" id="verbatimlatitude" value="#verbatimlatitude#">
            ...
            <input type="text" title="verbatimlongitude" name="verbatimlongitude" size="14" id="verbatimlongitude" value="#verbatimlongitude#"></td>
        </tr>
        <tr>
            <td align="right"><span class="f11a">Verbatim Coordinate System</span></td>
            <td><input type="text" title="verbatimcoordinatesystem" name="verbatimcoordinatesystem" size="24" id="verbatimcoordinatesystem" value="#verbatimcoordinatesystem#">
                <span class="f11a">(e.g., decimal degrees, degrees minutes seconds, etc.)</span></td>
        </tr>
        <td align="right"><span class="f11a">Verbatim SRS or Datum</span></td>
        <td><input type="text" title="verbatimsrs" name="verbatimsrs" size="24" id="verbatimsrs" value="#verbatimsrs#">
            <span class="f11a">(e.g., WGS84, Clark 1866, etc.)</span></td>
        </tr>
        <tr>
        <tr>
            <td id="d_orig_elev_units" align="right"><span class="f11a">Elevation between</span></td>
            <td><input type="text" title="MINIMUM_ELEVATION" name="minimum_elevation" size="4" value="#minimum_elevation#" id="minimum_elevation">
                ...
                <span class="f11a">(minimum-maximum)</span></td>
        </tr>
        ...
        <cfif collection_cde is not "VP" and collection_cde is not "IP" and collection_cde is not "Orn" and collection_cde is not "Model">
            <tr>
                <td id="d_orig_depth_units" align="right"><span class="f11a">Depth between</span></td>
                <td><input type="text" name="min_depth" size="4" title="MIN_DEPTH" value="#min_depth#" id="min_depth">
                    ...
                    <span class="f11a">(shallowest-deepest)</span></td>
            </tr>
        </cfif>
        <tr id="d_coll_event_remarks">
            <td align="right"><span class="f11a">Coll.&nbsp;Event&nbsp;Remark</span></td>
            <td><input type="text" title="COLL_EVENT_REMARKS" name="coll_event_remarks" size="75" value="#coll_event_remarks#" id="coll_event_remarks"></td>
        </tr>
        <tr id="d_locality_remarks">
            <td align="right"><span class="f11a" onclick="checkPicked()">Locality Remark</span></td>
            <td><input type="text" title="LOCALITY_REMARKS" name="locality_remarks" size="75" value="#locality_remarks#" id="locality_remarks"></td>
        </tr>
        <tr>
            <td colspan="3"><table>
                    <tr>
                        <td><span class="f11a">OR only use ID</span></td>
                        <td id="d_locality_id" class="extLoc"><label style="float: left;padding-left: 1em;" for="fetched_locid">Existing Locality ID</label>
                            ...
                            <span class="infoLink" id="localityPicker"
												onclick="LocalityPick('locality_id','spec_locality','dataEntry','turnSaveOn'); return false;"> Pick&nbsp;Locality&nbsp;&nbsp; </span> <span class="infoLink"
												id="localityUnPicker"
												style="display:none;"
												onclick="unpickLocality()"> Depick&nbsp;Locality </span></td>
                        <td id="d_collecting_event_id" class="extLoc"><label style="text-align: right;padding-left:3px;" for="collecting_event_id">Existing Event ID</label>
                            ...
                            <span class="infoLink" id="eventPicker" onclick="findCollEvent('collecting_event_id','dataEntry','verbatim_locality'); return false;"> Pick Event&nbsp; </span> <span class="infoLink" id="eventUnPicker" style="display:none;" onclick="unpickEvent()"> Depick&nbsp;Event </span></td>
                    </tr>
                </table></td>
        </tr>
        </table>
        ...
        <td valign="top"><!----- right column ---->
            ...
            <table class="fs" id="d_orig_lat_long_units">
                <!------- coordinates ------->
                <tr>
                    <td rowspan="99" valign="top"><img src="/images/info.gif" border="0" onClick="getMCZDocs('Georeferencing - Data Entry')" class="likeLink" alt="[ help ]"></td>
                    <td><table>
                            <tr>
                                <td align="right"><span class="f11a">Original&nbsp;lat/long&nbsp;Units</span></td>
                                <td colspan="99" width="100%"><cfset thisLLUnits=#ORIG_LAT_LONG_UNITS#>
                                ...
                                <td valign="top"><span style="font-size:small" class="likeLink" onclick="geolocate()">GEOLOCATE</span></td>
                                <td valign="top"><div id="geoLocateResults" style="font-size:small"></div></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                    <td><div id="lat_long_meta" class="noShow">
                            <table>
                                <tr>
                                    <td align="right"><span class="f11a">Max Error</span></td>
                                    <td><input type="text" title="MAX_ERROR_DISTANCE" name="max_error_distance" id="max_error_distance" value="#max_error_distance#" size="10">
                                    ...
                                    <td><input type="text" title="EXTENT" name="extent" id="extent" value="#extent#" size="10"></td>
                                </tr>
                                <tr>
                                    <td align="right"><span class="f11a">GPS Accuracy</span></td>
                                    <td><input type="text" title="GPSACCURACY" name="gpsaccuracy" id="gpsaccuracy" value="#gpsaccuracy#" size="10"></td>
                                    <td align="right"><span class="f11a">Datum</span></td>
                                    <td><select name="datum" title="DATUM" size="1" class="reqdClr" id="datum">
                                            <option value=""></option>
                                ...
                                <tr>
                                    <td align="right"><span class="f11a">Determiner</span></td>
                                    <td><input type="text" name="determined_by_agent" value="#determined_by_agent#" class="reqdClr"
                                    ...
                                    <td><input type="text" title="DETERMINED_DATE" name="determined_date" class="reqdClr" value="#determined_date#" id="determined_date">
                                        <span class="infoLink" onclick="copyAllDates('determined_date');">Copy2All</span></td>
                                </tr>
                                <tr>
                                    <td align="right"><span class="f11a">Reference</span></td>
                                    <td colspan="3" nowrap="nowrap"><input type="text" title="LAT_LONG_REF_SOURCE" name="lat_long_ref_source" id="lat_long_ref_source"  class="reqdClr"
												size="60" value="#lat_long_ref_source#">
                                        <span class="infoLink" onclick="getHelp('lat_long_ref_source');">Pick</span></td>
                                </tr>
                                <tr>
                                    <td align="right"><span class="f11a">Georef Meth</span></td>
                                    <td><select name="georefmethod" size="1" title="GEOREFMETHOD" class="reqdClr" style="width:130px" id="georefmethod">
                                    ...
                                    <td><cfset thisverificationstatus = #verificationstatus#>
                                ...
                                <tr id="d_lat_long_remarks">
                                    ...
                                    <td colspan="3"><input type="text" name="lat_long_remarks" size="80" value="#lat_long_remarks#" id="lat_long_remarks"></td>
                                </tr>
                            </table>
                        </div>
                        <div id="dms" class="noShow">
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" title="LATDEG" name="latdeg" size="4" id="latdeg" class="reqdClr" value="#latdeg#"></td>
                                    ...
                                    <td><select name="latdir" title="LATDIR" size="1" id="latdir" class="reqdClr">
                                            <option value=""></option>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"
                                                ...
                                                title="LONGSEC"></td>
                                    <td align="right"><span class="f11a">Dir</span></td>
                                    <td><select name="longdir" size="1" title="LONGDIR" id="longdir" class="reqdClr">
                                            <option value=""></option>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text"
												...
												value="#latdeg#"
                                                title="DEC_LAT_DEG"
												onchange="dataEntry.latdeg.value=this.value;"></td>
                                    ...
                                    <td><input type="text"
                                                ...
                                                title="DEC_LAT_MIN"
												class="reqdClr"
												value="#dec_lat_min#"></td>
                                    <td align="right"><span class="f11a">Dir</span></td>
                                    <td><select name="decLAT_DIR"
												size="1"
												id="decLAT_DIR"
												class="reqdClr"
                                                title="LATDIR"
                                ...
                                <tr>
                                    ...
                                    <td><input type="text"
												...
												class="reqdClr"
												value="#longdeg#"
												onchange="dataEntry.longdeg.value=this.value;"></td>
                                    <td align="right"><span class="f11a">Dec Min</span></td>
                                    <td><input type="text"
												name="DEC_LONG_MIN"
												size="8"
												id="dec_long_min"
												class="reqdClr"
												value="#DEC_LONG_MIN#"></td>
                                    <td align="right"><span class="f11a">Dir</span></td>
                                    <td><select name="decLONGDIR"
												 size="1"
												id="decLONGDIR"
												class="reqdClr"
                                                title="LONGDIR"
                        ...
                        <div id="dd" class="noShow"> <span class="f11a">Dec Lat</span>
                            <input type="text"
									 name="dec_lat"
									size="8"
									id="dec_lat"
                        ...
                        <div id="utm" class="noShow"> <span class="f11a">UTM Zone</span>
                            <input type="text"
									 name="utm_zone"
									size="8"
									id="utm_zone"
            ...
            <cfif collection_cde is "ES" or collection_cde is "VP" or collection_cde is "IP">
                ...
                <div id="geolCell">
                    <table class="fs">
                        <tr>
                            <td><img src="/images/info.gif" border="0" onClick="getMCZDocs('Geology Attributes - Data Entry')" class="likeLink" alt="[ help ]">
                                <table>
                                    <tr>
                                    ...
                                    <cfloop from="1" to="6" index="i">
                                        ...
                                        <div id="#i#">
                                            <tr id="d_geology_attribute_#i#">
                                                <td><select name="geology_attribute_#i#" id="geology_attribute_#i#" size="1" title="GEOLOGY_ATTRIBUTE_X" onchange="populateGeology(this.id);">
                                                        <option value=""></option>
                                                ...
                                                <td><select title="GEO_ATT_VALUE_X" name="geo_att_value_#i#" id="geo_att_value_#i#">
            ...
            <table class="fs">
                <!----- attributes ------->
                <tr>
                    <td><img src="/images/info.gif" onClick="getMCZDocs('Attributes - Data Entry')" class="likeLink" alt="[ help ]">
                        <cfif collection_cde is not "Crus" and collection_cde is not "Herb"
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td nowrap="nowrap"><span class="f11a">Sex</span>
                                        ...
                                        <input type="text" title="ATTRIBUTE_DATE_X" name="attribute_date_1" value="#attribute_date_1#" id="attribute_date_1" size="10"
											...
											>
                                        <span class="infoLink" onclick="copyAttributeDates('attribute_date_1');">Sync Att.</span> <span class="f11a">Detr</span>
                                        <input type="text"
                                        ...
                                        <span class="infoLink" onclick="copyAttributeDetr('attribute_determiner_1');">Sync Att.</span> <span class="f11a">Meth</span>
                                        <input
                                            size="15"
                                            title="ATTRIBUTE_DET_METH_1" type="text" name="attribute_det_meth_1"
												value="#attribute_det_meth_1#"
												id="attribute_det_meth_1"></td>
                                </tr>
                            </table>
                            <cfelse>
                        ...
                        <table cellpadding="1">
                            <cfif collection_cde is "Mamm">
                                ...
                                <tr>
                                    <td><input type="hidden" name="attribute_2" value="total length" />
                                        <input type="text" title="ATTRIBUTE_VALUE_2" name="attribute_value_2" value="#attribute_value_2#" size="3" id="attribute_value_2"></td>
                                    <td><input type="hidden" name="attribute_units_3" value="#attribute_units_3#" id="attribute_units_3" />
                                        ...
                                        <input type="text" title="ATTRIBUTE_VALUE_3" name="attribute_value_3" value="#attribute_value_3#" size="3" id="attribute_value_3"></td>
                                    <td align='center'><input type="hidden" name="attribute_units_4" value="#attribute_units_4#" id="attribute_units_4" />
                                        ...
                                        <input type="text"  name="attribute_value_4" value="#attribute_value_4#" title="ATTRIBUTE_VALUE_4" size="3" id="attribute_value_4"></td>
                                    <td align='center'><input type="hidden" name="attribute_units_5" value="#attribute_units_5#" id="attribute_units_5" />
                                        ...
                                        <input type="text" title="ATTRIBUTE_VALUE_5" name="attribute_value_5" value="#attribute_value_5#" size="3" id="attribute_value_5"></td>
                                    <td><select name="attribute_units_2" size="1" id="attribute_units_2">
                                            <option value=""></option>
                                    ...
                                    <td><input type="hidden" name="attribute_date_6" value="#attribute_date_6#" id="attribute_date_6" />
                                        ...
                                        <input type="text" title="ATTRIBUTE_VALUE_6" name="attribute_value_6" value="#attribute_value_6#" size="3" id="attribute_value_6"></td>
                                    <td><select name="attribute_units_6" title="ATTRIBUTE_UNITS_6" size="1" id="attribute_units_6">
                                            <option value=""></option>
                                    ...
                                    <td><input type="text" title="ATTRIBUTE_DATE_2" name="attribute_date_2" id="attribute_date_2" value="#attribute_date_2#"></td>
                                    <td><input type="text" title="ATTRIBUTE_DETERMINER_2" name="attribute_determiner_2" id="attribute_determiner_2"
                                ...
                                <tr>
                                    ...
                                    <td><span class="f11a">Determiner</span></td>
                                <tr>
                                    <td><input type="hidden" name="attribute_2" value="age class" />
                                    ...
                                    <td><input type="hidden" name="attribute_date_3" value="#attribute_date_3#" id="attribute_date_3" />
                                        <input type="hidden" name="attribute_determiner_3" value="#attribute_determiner_3#" id="attribute_determiner_3" />
                                        <input type="hidden" name="attribute_3" value="fat deposition" />
                                        <input type="text" name="attribute_value_3" value="#attribute_value_3#" size="12" id="attribute_value_3"></td>
                                    <td><input type="hidden" name="attribute_date_4" value="#attribute_date_4#" id="attribute_date_4" />
                                        <input type="hidden" name="attribute_determiner_4" value="#attribute_determiner_4#" id="attribute_determiner_4" />
                                        <input type="hidden" name="attribute_4" value="molt condition" />
                                        <input type="text" name="attribute_value_4" value="#attribute_value_4#" size="12" id="attribute_value_4"></td>
                                    <td><input type="hidden" name="attribute_date_5" value="#attribute_date_5#" id="attribute_date_5" />
                                        <input type="hidden" name="attribute_determiner_5" value="#attribute_determiner_5#" id="attribute_determiner_5" />
                                        <input type="hidden" name="attribute_5" value="ossification" />
                                        <input type="text" name="attribute_value_5" value="#attribute_value_5#" size="13" id="attribute_value_5"></td>
                                    <td><input type="hidden" name="attribute_date_6" value="#attribute_date_6#" id="attribute_date_6" />
                                        <input type="hidden" name="attribute_determiner_6" value="#attribute_determiner_6#" id="attribute_determiner_6" />
                                        <input type="hidden" name="attribute_6" value="weight" />
                                        <input type="text" name="attribute_value_6" value="#attribute_value_6#" size="2" id="attribute_value_6"></td>
                                    <td><select name="attribute_units_6" size="1" id="attribute_units_6" style="width: 35px;">
                                            <cfloop query="ctWeight_Units">
                                                <option <cfif #data.attribute_units_6# is #Weight_Units#> selected </cfif>value="#Weight_Units#">#Weight_Units#</option>
                                            </cfloop>
                                        </select></td>
                                    <td><input type="text" name="attribute_date_2" id="attribute_date_2" value="#attribute_date_2#" size="9"></td>
                                    <td><input type="text"
        ...
        onchange="getAgent('nothing',this.id,'dataEntry',this.value);"
                        ...
                        <table>
                            ...
                            <cfloop from="7" to="14" index="i">
                                <tr id="de_attribute_#i#">
                                    <td><select title="ATTRIBUTE_X" name="attribute_#i#" onChange="getAttributeStuff(this.value,this.id);"
                                    ...
                                    <td><div id="attribute_value_cell_#i#">
                                    ...
                                    <td><div id="attribute_units_cell_#i#">
                                    ...
                                    <td><input type="text" title="ATTRIBUTE_DATE_X" name="attribute_date_#i#" value="#evaluate("data.attribute_date_" & i)#"
												id="attribute_date_#i#" size="9"></td>
                                    <td><input type="text" name="attribute_determiner_#i#"
												id="attribute_determiner_#i#" size="14"
                                                title="ATTRIBUTE_DETERMINER_X"
												value="#evaluate("data.attribute_determiner_" & i)#"
												onchange="getAgent('nothing',this.id,'dataEntry',this.value);"
												onkeypress="return noenter(event);"></td>
                                    <td><input type="text" name="attribute_det_meth_#i#"
												title="ATTRIBUTE_DET_METH_X" id="attribute_det_meth_#i#" size="12" value="#evaluate("data.attribute_det_meth_" & i)#"></td>
                                    <td><input type="text" title="ATTRIBUTE_REMARKS_X" name="attribute_remarks_#i#"
												id="attribute_remarks_#i#"
												value="#evaluate("data.attribute_remarks_" & i)#"></td>
                                </tr>
                            </cfloop>
                        </table></td>
                </tr>
            ...
            <table class="fs">
                ...
                <tr>
                    ...
                    <td width="100%"><cfif ImAGod is not "yes">
                ...
                <tr id="d_relationship">
                    ...
                    <td><cfset thisRELATIONSHIP = RELATIONSHIP>
                        ...
                        <input type="text" value="#related_to_number#" name="related_to_number" id="related_to_number" size="10" /></td>
                </tr>
            </table>
            ...
            <table class="fs">
                ...
                <tr id="d_coll_object_remarks">
                    <td colspan="2"><span class="f11a">Spec Remark</span>
                        <textarea name="coll_object_remarks" id="coll_object_remarks" rows="2" cols="60">#coll_object_remarks#</textarea></td>
                </tr>
                <tr>
                    <td id="d_flags"><span class="f11a">Missing....</span>
                    ...
                    <td><span class="f11a">Status</span> #loaded#</td>
                </tr>
            </table>
        ...
        <!---- end top row of page --->
        <tr>
        <!---- start bottom row of page --->
        
        <td colspan="2">
        <!-------- parts block ---------->
        
        <table class="fs" style="position: relative;">
        <tr>
        ...
        <cfloop from="1" to="12" index="i">
            ...
            <td><cfset tpn=evaluate("data.part_name_" & i)>
                <input type="text" name="part_name_#i#" id="part_name_#i#" <cfif i is 1>class="reqdClr"</cfif>
									...
									onkeypress="return noenter(event);"></td>
            <td><cfset tprm=evaluate("data.preserv_method_" & i)>
            ...
            <td><input type="text" name="part_condition_#i#" id="part_condition_#i#" size="13"
									<cfif i is 1>class="reqdClr" </cfif>value="#evaluate("data.part_condition_" & i)#"></td>
            <td><select id="part_disposition_#i#" name="part_disposition_#i#" <cfif i is 1>class="reqdClr"</cfif>>
                    <option value=""></option>
            ...
            <td><select id="part_lot_cnt_mod_#i#" name="part_lot_cnt_mod_#i#">
                    <option value=""></option>
            ...
            <td><input type="text" name="part_lot_count_#i#" id="part_lot_count_#i#" value="#evaluate("data.part_lot_count_" & i)#"
									<cfif i is 1>class="reqdClr" </cfif>size="1"></td>
            <td><input type="text" name="part_container_unique_id_#i#" id="part_container_unique_id_#i#" value="#evaluate("data.part_container_unique_id_" & i)#"
                ...
                <input type="text" name="part_remark_#i#" id="part_remark_#i#"
									value="#evaluate("data.part_remark_" & i)#" size="80"></td>
                    ...
                    <div class="div1">
                        <ul class="atts">
                            <li><span>Attribute #j#</span>
                                <input class="part_at" type="text" name="part_#i#_att_name_#j#" id="part_#i#_att_name_#j#" value="#pan#" size="25" onkeypress="return noenter(event);">
                                <input type="hidden" name="step2" value="yes">
                            </li>
                            <cfset pav=evaluate("data.part_" & i & "_att_val_" & j)>
                            <li> <span>Value #j#</span>
        ...
        </span> <span id="enterMode" style="display:none;">
        <input type="button"
								...
								onclick="editThis();">
        </span> <span id="editMode" style="display:none">
        <input type="button"
									value="Clone This Record"
									class="lnkBtn"
                                       style="font-size: 13px;padding: 2px 10px;"
									onclick="createClone();">
        </span> <span id="theSaveButton" style="display:none;">
        ...
        </span> <a href="userBrowseBulkedGrid.cfm?action=ajaxGrid">[ AJAX table ]</a> <span id="recCount">#whatIds.recordcount#</span> records <span id="browseThingy"> - Jump to 
