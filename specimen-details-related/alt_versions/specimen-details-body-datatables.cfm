<cfif not isdefined("toProperCase")></cfif>
<cfoutput>
...
<cfoutput query="one">
<cfif oneOfUs is 1>
<form name="editStuffLinks" method="post" action="/redesign/specimen-details.cfm">
         ...
         <div class="card">
            ...
            <div class="card-body">
                ...
                <cfloop query="identification">
                        ...
                        <p>
							<span class="font-weight-light font-italic" style="font-size: 19px;font-weight:700">
                    ...
                    <p style="font-size: .9em;"> #agent_name#
                        <cfif len(made_date) gt 0>on #dateformat(made_date,"yyyy-mm-dd")#
                        </cfif>
                        <span >, #nature_of_id#</span> 
                    </p>
...
<cfelse>
                    <ul class="list-group" style="padding: 15px 25px;padding-bottom:0;color: ##666">
                       <li class="pid">     <span class="d-inline-block text-success">Prior Identification</span></li>
                         <cfif getTaxa.recordcount is 1 and taxa_formula is 'a'>
                        <p>
...
<!------------------------------------ citations ------------------------------------------>
        <cfif len(citations.cited_name) gt 0>
          <div class="card">
                  <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Citations</h5>
            </div>
            <div class="card-body">
                    ...
                    <cfloop query="publicationMedia">
                        <li class="list-group-item"> 
                            ...
                            <!--- <a href="#media_uri#" target="_blank"><img src="#getMediaPreview(preview_uri,media_type)#" alt="#alt#" class="theThumbSmall"></a>---> 
                                  <img src="http://www.archive.org/download/proceedingsofnew04newe/page/n22_w392" width="70" height="100" style="float: left;margin-right: 8px;"> 
                            <span style="font-size: .9em;">#media_type# (#mime_type#)<br>
...
<!------------------------------------ accession ------------------------------------------>
        ...
        <cfif oneOfUs is 1 and vpdaccn is 1>
            <div class="card">
                   <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Transactions</h5>
            </div>
                <!---<cfif oneOfUs is 1>
...
<!------------------------------------ relationships  ------------------------------------->       
        <cfif len(relns.biol_indiv_relationship) gt 0 >
              <div class="card">
                   <div class="card-header"><h5>Relationships</h5></div>              
        <!--- <cfif oneOfUs is 1>
...
<!------------------------------------ other identifiers ---------------------------------->  
        ...
        <cfif len(oid.other_id_type) gt 0>
              <div class="card">
				      <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Other IDs</h5>
            </div>
                        <!---  <cfif oneOfUs is 1>
                       ...
                       <table class="table table-striped table-bordered table-hovered table-responsive-md table-responsive-sm" style="margin-bottom:0">
                            <tr>
                             ...
                             <!---   <th scope="col"><span class="innerDetailLabel">Condition</span></th>--->
                                ...
                                <cfif oneOfus is "1">
                                    <th scope="col"  style="width: 250px;"><span class="innerDetailLabel">Container Name</span></th>
                                </cfif>
                            ...
                            <cfloop query="mPart">
                                    ...
                                    <tr>
                                        <td colspan="6" class="partnameatts">
                                           <cfloop query="patt">
                                                ...
                                                <div style="margin-left:1.5em;font-size: smaller;width: 100%;">
                                ...
                                <cfloop query="sPart">
                                    <tr>
                                        <td style="font-size: smaller"><span>#part_name# subsample</span></td>
                                      <!---  <td style="font-size: smaller">#part_condition#</td>--->
                                        <td cstyle="font-size: smaller">#part_disposition#</td>
                                        <td style="font-size: smaller">#lot_count#</td>
                                        <cfif oneOfus is 1>
                                            <td cstyle="font-size: smaller">#label#</td>
                                        </cfif>
                                        <td cstyle="font-size: smaller">#part_remarks#</td>
                                    </tr>
                                </cfloop>
                            </cfloop>
                        </table>
...
<!------------------------------------ media ---------------------------------------------->
        <cfif len(citations.cited_name) gt 0>
			...
			select * from media where mime_type = 'application/pdf'
                ...
                <!---"thumbs"--->
                <div class="card  card-primary p-3 bg-light text-left">
                    <h5>Media</h5>
                    <ul class="list-group" style="margin-bottom: 10px;">
                        <cfloop query="media">
                            <!---<cfset puri=getMediaPreview(preview_uri,media_type)>--->
                            ...
                            <li class="list-group-item"><img src="/redesign/includes/images/Amber_Orchid_Bee_nsf3.jpg" style="float: left;margin-right: 10px;"> #one_thumb#
                                <p style="font-size: .95em;line-height: 1.2em;"> #media_type# (#mime_type#)<br>
   ...
   <!------------------------------------ locality ------------------------------------------->         
        <div class="card">
           <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Locality Details</h5></div>
    ...
    <li class="list-group-item col-6">#one.continent_ocean#</li>
     ...
     <cfif len(one.sea) gt 0>
		 ...
		 <li class="list-group-item col-6">#one.sea#</li></cfif>
    ...
    <li class="list-group-item col-6 last">#one.spec_locality#</li>
        ...
        <div class="card">
              <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Collecting Event</h5></div>
            <div class="card-body">
                        <ul class="list-unstyled row" style="padding: 0 20px;">
    <cfif len(one.sea) gt 0>
    ...
    <li class="list-group-item col-6">John Smith</li>
     ...
     <cfif len(one.verbatim_locality) gt 0>
		 ...
		 <li class="list-group-item col-6">#one.verbatim_locality#</li></cfif>
...
<!------------------------------------ metadata ------------------------------------------->
      ...
      <cfif oneOfUs is 1>
           <div class="card">
                 <div class="card-header"><h5 style="margin-bottom: 0;font-size: 15px;">Metadata</h5>
            </div>
            <div class="card-body">
