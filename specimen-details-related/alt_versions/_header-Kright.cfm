...
<script src="/redesign/includes/js/jquery.mobile-1.4.5.min.js"></script>  
<link href="/redesign/includes/css/custom-datatables-Kright.css" rel="stylesheet">
<script src="/redesign/includes/js/jquery-1.7.1.min.js"></script>
...
<header>
    ...
    <nav class="navbar justify-content-start navbar-expand-md navbar-expand-sm navbar-harvard pt-2 pb-1" style="background-color: ##a51c30;margin-block-end:0px;padding: .5rem .25rem .7rem .5rem">
        <ul class="navbar col-lg-9 col-md-8 col-sm-9 pt-0 pb-0 mb-1">
           ...
           <li class="nav-item mczbase"><a href="/redesign/specimen-search-kr-right.cfm" target="_blank">MCZbase: Database of Zoological Collections</a></li>
        </ul>
        ...
        <li class="nav-item" style="list-style: none;align-content: flex-end">
           <!---<img class="mcz_logo_krono" src="includes/images/mcz_logo_white175.png" width="160">--->
            <img class="mcz_logo_krono" src="includes/images/mcz_logo_white_left.png" width="160">
        </li>
			</div>
		</ul>
        ...
        <div class="container" style="padding: 5px;">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav nav-fill w-100">
                    <li class="nav-item dropdown active"> <a class="nav-link dropdown-toggle" href="https://mczbase-dev.rc.fas.harvard.edu/redesign/specimen-search-kr-right.cfm" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Search</a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown"> <a class="dropdown-item" href="https://mczbase-dev.rc.fas.harvard.edu/redesign/specimen-search-kr-right.cfm">Specimens</a> <a class="dropdown-item" href="#">Media</a> <a class="dropdown-item" href="#">Places</a> <a class="dropdown-item" href="#">Publications</a> <a class="dropdown-item" href="#">Projects</a> <a class="dropdown-item" href="#">Taxonomy</a></div>
                    </li>
