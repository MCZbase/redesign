...
<cfoutput query="one">
	...
	function loadLocality(locality_id) {
    jQuery.ajax({
          url: "/redesign/component/functions.cfc",
          data : {
            method : "getShipmentsByTransHtml",
            transaction_id : locality_id
         },
	...
	$( document ).ready(loadLocality(#locality_id#));
	    $(function() {
	      $("##dialog-editLoc").dialog({
	        autoOpen: false,
	        modal: true,
		  width: 'auto',
	  height: 'auto',
	        ...
	        buttons: {
	          "Save": function() {  saveLocality(#locality_id#); } ,
	          Cancel: function() {
	            $(this).dialog( "close" );
	          }
	        },
...
function opendialog(page,id,title) {
  ...
  .dialog({
    ...
    draggable:true,
    resizable:true,
    buttons: { "Ok": function () { loadLocality(#locality_id#); $(this).dialog("destroy"); $(id).html(''); } },
    close: function() { loadLocality(#locality_id#);  $(this).dialog("destroy"); $(id).html(''); }
  });
  adialog.dialog('open');
};
</script>
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" id="edit-locality" class="detail-edit-cell" onClick="$('##dialog-editLoc').dialog('open'); setupNewLocality(#locality_id#);">Edit</button>
            ...
            <style>
				##dialog-editLoc {width: 100%;}
	table.inputTable tr td label {padding-top: 5px;margin: 0 14px;margin-bottom: 2px;}
	input {margin: 0 4px;}
				table.inputTable tr {background-color:white;}
	</style>
            <div id="dialog-editLoc" title="Edit Locality">
                <div style="border: 3px solid red;padding: 15px;padding-bottom:0; margin: 2px;margin-top: 2em;margin-bottom: 10px;border-radius: 5px;">This locality includes:
                    <ul>
                        <li style="list-style: none;"><a>3 mammals</a></li>
                        <li style="list-style: none;"><a>4 invertebrates (IZ)</a></li>
                    </ul>
                </div>
                <hr>
                <form name="localityForm" id="localityForm"  class="mt-3">
                    <fieldset>
                        ...
                        <table class="mt-4 inputTable">
                            <tr>
                                <td><label for="specific_locality">Specific Locality</label>
                                    <input type="text" value="#one.spec_locality#" name="spec_locality" id="spec_locality" size="26" ></td>
                                <td colspan="2"><label for="sovereign_nation">Sovereign Nation</label>
                                    <input type="text" value="" name="sovereign_nation" id="sovereign_nation" size="26" ></td>
                            </tr>
                        </table>
                        <table class="inputTable">
                            <tr>
                                <td colspan="2"><label for="minimum_elevation">Minimum Elevation</label>
                                    <input type="text" value="" name="minimum_elevation" id="minimum_elevation" size="10" ></td>
                                <td colspan="2"><label for="maximum_elevation">Maximum Elevation</label>
                                    <input type="text" value="" name="maximum_elevation" id="maximum_elevation" size="10" ></td>
                                <td colspan="2"><label for="orig_elev_units">Elev. Units</label>
                                    <input type="text" value="" name="orig_elev_units" id="orig_elev_units" size="5" ></td>
                            </tr>
                            <tr>
                                <td colspan="2"><label for="minimum_elevation">Minimum Depth</label>
                                    <input type="text" value="" name="minimum_elevation" id="minimum_elevation" size="10" ></td>
                                <td colspan="2"><label for="maximum_elevation">Maximum Depth</label>
                                    <input type="text" value="" name="maximum_elevation" id="maximum_elevation" size="10" ></td>
                                <td colspan="2"><label for="orig_elev_units">Depth Units</label>
                                    <input type="text" value="" name="orig_elev_units" id="orig_elev_units" size="5" ></td>
                            </tr>
                        </table>
                    </fieldset>
                ...
                <table>
                    <tr>
                        <td colspan="6" style="background-color: white;" ><label for="higher_geog" class="mt-3" style="font-size: 12px;letter-spacing: -.01em;font-weight: bold;"><a href="">Search Tool: Higher Geography</a></label>
                            #getGeo.higher_geog#</td>
                    </tr>
                    <tr>
                        <td colspan="6" ><label for="verbatim_locality" class="mt-3" style="font-size: 12px;letter-spacing: -.01em;font-weight: bold;"><a href="">Collecting Event: Verbatim Locality</a></label>
                            #one.verbatim_locality#</td>
                    </tr>
                    <tr style="background-color: white;">
                        <td colspan="6"><label for="lat_long" class="mt-2" style="font-size: 12px;letter-spacing: -.01em;font-weight: bold;">Coordinates for this Locality</label>
