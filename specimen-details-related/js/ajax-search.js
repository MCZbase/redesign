	  $(document).ready(function () {
	  	$('#searchForm').bind('submit', function (evt) {
	  		...
	  		$("#jqxgrid").jqxGrid({
	  			...
	  			columns: [{
	  				text: 'Link',
	  				datafield: 'collection_object_id',
	  				width: 100,
	  			...
	  			initwidget: function (row, column, value, htmlElement) {}
	  				...
	  				text: 'Locality',
	  				datafield: 'spec_locality',
	  				width: 250
	  			}, {
	  				text: 'Higher Geography',
	  				datafield: 'higher_geog',
	  				width: 280
	  			}, {
	  				text: 'Collectors',
	  				...
	  				text: 'Verbatim Date',
	  				datafield: 'verbatim_date',
	  				width: 190
	  			}, {
	  				text: 'Disposition',
	  				datafield: 'coll_obj_disposition',
	  				width: 120
	  			}, {
	  				text: 'Other IDs',
	  				datafield: 'othercatalognumbers',
	  				width: 280
	  			}]
	  		...
	  		$("#columnchooser").jqxDropDownList({
	  			...
	  			source: [{
	  					...
	  					label: 'Disposition',
	  					value: 'coll_obj_disposition'
	  				}, {
	  					label: 'Other IDs',
	  					value: 'othercatalognumbers'
	  				}
