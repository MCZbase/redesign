<cfset pageTitle = "Taxonomy Details">
		...
		<ul>
			...
			<cfelse>
				<cfloop query="related">
					<li>
						#TAXON_RELATIONSHIP# of <a href="/redesign/taxonomy-detail.cfm?taxon_name_id=#RELATED_TAXON_NAME_ID#"><i><b>#related_name#</b></i></a>
				...
				<cfloop query="imp_related">
					<li>
						<a href="/redesign/taxonomy-detail.cfm?taxon_name_id=#imp_RELATED_TAXON_NAME_ID#"><i><b>#imp_related_name#</b></i></a>
