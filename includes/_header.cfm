                ...
                <ul class="navbar-nav nav-fill w-100">
                    ...
                    <li class="nav-item dropdown"> 
                      ...
                      <ul class="dropdown-menu" aria-labelledby="navbarDropdown"> 
                          ...
                          <li><a class="dropdown-item" href="#">More Bulkloaders</a></li>
                      </ul>
                    </li>
                    <li class="nav-item dropdown"> 
                        ...
                        <div class="row">
                            <div class="container-fluid">
                                <form class="">
                                    <div class="form-group">
                                        <label>Profile</label>
                                        <input class="m-0 form-control form-control-sm" name="username" id="username" type="text">
                                    </div>
                                    <div class="form-group">
                                        <label>Change Password</label>
                                        <input class="m-0 form-control form-control-sm" name="password" id="password" type="password">
                                        <br/>
                                    </div>
