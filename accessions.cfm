        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-4 jumbotron pt-0">
                <form id="searchForm" class="card card-sm" style="border: none;">
                    <h2 class="mt-2 mb-1 mx-5">Search Accessions </h2>
            ...
            <div class="col-sm-12 col-md-12 col-lg-4 jumbotron pt-0">
                 <div class="row no-gutters align-items-left py-1 mx-3">
                    ...
                    <p class="card card-sm mx-3" style="border: none;display: inline;"> These <a href="##" style="color: green;">341645</a> records show the collections donated or bought by the Museum of Comparative Zoology. These online records may not be complete but paper copies exist at the MCZ. Not all accessions are animal specimens. </p>
                 </div>
                </p>
            </div>
...
//////////////////////
 ...
 <h3 style="width: 150px;float: left;">Accessions</h3>  
