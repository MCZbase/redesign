...
<cfif action is "nothing">
    <cfoutput>
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 jumbotron pt-0">
                    <main role="main"> <cfoutput>
					...
					insert into bulkloader (
						...
						'#ucase(institution_acronym)# #ucase(collection_cde)# TEMPLATE')
                            ...
                            <div class="container"> <br/>
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 jumbotron pt-0">
                                        <h3>Data Entry (and Edit) Application</h3>
                                        <ul>
                                        ...
                                        If you have data to enter in bulk, use the <a href="/redesign/Bulkloader/">bulkload</a> feature.
                                        <p class="my-2"><a href="/redesign/Bulkloader/cloneWithBarcodes.cfm">Clone records by Container Unique ID</a></p>
			...
			GROUP BY
				...
				institution_acronym
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-12 jumbotron pt-0">
                                        <p>Begin at....</p>
                                        <form name="begin" method="post" action="/redesign/data-entry.cfm">
                                            <ul>
                                                <li style="list-style: none; float: left; width: auto;">
							...
							select collection from c where institution_acronym='#instAc#' and collection_cde='#collnCde#'
                                                ...
                                                <li style="list-style: none; float: left; width: auto;">
                                                    <input class="lnkBtn" type="submit" onmouseover="this.className='lnkBtn btnhov'" onmouseout="this.className='lnkBtn'" value="Enter Data"/>
                                                </li>
                                            </ul>
                                        </form>
                                    </div>
        ...
        <div class="container-fluid">
            <div class="form-group row">
                ...
                <form name="dataEntry" class="form-inline" method="post" action="/redesign/data-entry.cfm" onsubmit="return cleanup(); return noEnter();" id="dataEntry">
                    ...
                    <input type="hidden" name="ImAGod" value="#ImAGod#" id="ImAGod">
