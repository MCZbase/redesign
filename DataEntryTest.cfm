...
<cfoutput>
    ...
    <p>Begin at....</p>
    <form name="begin" method="post" action="DataEntryTest.cfm">
...
<cfif action is "editEnterData">
    ...
    <cfoutput> 
        ...
        <form name="dataEntry" method="post" action="DataEntryTest.cfm" onsubmit="return cleanup(); return noEnter();" id="dataEntry">
            <input type="hidden" name="action" value="" id="action">
            <input type="hidden" name="nothing" value="" id="nothing"/>
            <!--- trashcan for picks - don't delete --->
            <input type="hidden" name="ImAGod" value="#ImAGod#" id="ImAGod">
            <!--- allow power users to browse other's records --->
            ...
            <table width="100%" id="theTable" style="display:show;height: auto; ">
                <tr>
                    <td colspan="2" style="border-bottom: 1px solid black; " align="center"><div id="loadedMsgDiv">#loadedMsg#</div></td>
                </tr>
                <tr>
                    <td width="50%" valign="top"><!--- left top of page --->
                            ...
                            <tr>
								...
								---> 
                                    ...
                                    <cfif isdefined("session.CustomOtherIdentifier") and len(#session.CustomOtherIdentifier#) gt 0>
                                        <span id="d_other_id_num_type_5"> <span class="f11a">#session.CustomOtherIdentifier#</span>
                                    ...
                                    <span class="f11a">
                                    <input type="checkbox" style="vertical-align: bottom;" name="mask_record" value="1" <cfif #mask_record# EQ "1">checked</cfif>>
                                    mask record
                                    </input>
                                    </span></td>
                            </tr>
                        ...
                        <table class="fs">
                            <!--- agents --->
                            <tr>
                                <td rowspan="99" valign="top"><img src="/images/info.gif" onClick="getMCZDocs('Agent-Data Entry')" class="likeLink" alt="[ help ]"></td>
                            <cfloop from="1" to="8" index="i">
                                <cfif i is 1 or i is 3 or i is 5 or i is 7>
                                        <tr>
                                </cfif>
                                <td id="d_collector_role_#i#" align="right"><select name="collector_role_#i#" title="COLLECTOR_ROLE_X" size="1" <cfif i is 1>class="reqdClr"</cfif> id="collector_role_#i#">
                                    ...
                                    <td  id="d_collector_agent_#i#" nowrap="nowrap"><span class="f11a">#i#</span>
                                        ...
                                        <span class="infoLink" onclick="copyAllAgents('collector_agent_#i#');">Copy2All</span></td>
                                    <cfif i is 2 or i is 4 or i is 6 or i is 8>
                                            </tr>
                                    </cfif>
                            </cfloop>
                        </table>
                        ...
                        <table class="fs">
                            <!------ other IDs ------------------->
                            <tr>
                                <td rowspan="99" valign="top"><img src="/images/info.gif" border="0" onClick="getMCZDocs('Other ID - Data Entry')" class="likeLink" alt="[ help ]"></td>
                            </tr>
                            <cfloop from="1" to="4" index="i">
                                <tr>
                                    <td id="d_other_id_num_#i#"><span class="f11a">OtherID #i#</span>
                                        ...
                                        <input type="text" name="other_id_num_#i#" title="OTHER_ID_NUM_X" value="#evaluate("data.other_id_num_" & i)#" id="other_id_num_#i#"></td>
                                </tr>
                            </cfloop>
                        </table>
                        ...
                        <table class="fs">
                            <!----- identification ----->
                            <tr>
                                <td rowspan="99" valign="top"><img src="/images/info.gif" onClick="getMCZDocs('Identification')" class="likeLink" alt="[ help ]"></td>
                                <td align="right"><span class="f11a">Scientific&nbsp;Name</span></td>
                                <td width="100%"><input type="text" title="TAXON_NAME" name="taxon_name" value="#taxon_name#" class="reqdClr" size="40"
									id="taxon_name"
									onchange="taxaPickOptional('nothing',this.id,'dataEntry',this.value)"></td>
                            </tr>
                            <tr>
                                <td align="right"><span class="f11a">ID By</span></td>
                                <td><input type="text" name="id_made_by_agent" value="#id_made_by_agent#" class="reqdClr" size="40"
									id="id_made_by_agent" title="ID_MADE_BY_AGENT"
									onchange="getAgent('nothing',this.id,'dataEntry',this.value);"
									onkeypress="return noenter(event);">
                                    <span class="infoLink" onclick="copyAllAgents('id_made_by_agent');">Copy2All</span></td>
                            </tr>
                            <tr>
                                <td align="right"><span class="f11a">Nature</span></td>
                                <td><select name="nature_of_id" class="reqdClr" id="NATURE_OF_ID" title="NATURE_OF_ID">
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="made_date" value="#made_date#" id="made_date" title="MADE_DATE" style="width: 154px;">
                                    <span class="infoLink" onclick="copyAllDates('made_date');">Copy2All</span></td>
                            </tr>
                            <tr id="d_identification_remarks">
								...
								id="identification_remarks" size="75"></td>
                            </tr>
                        </table>
                        <!------ /identification -------->
                        ...
                        <table class="fs">
                            <!----- locality ---------->
                            <tr>
                                <td rowspan="99" valign="top"><img src="/images/info.gif" onClick="getMCZDocs('Locality - Data Entry')" class="likeLink" alt="[ help ]"></td>
                                <td align="right"><span class="f11a">Higher Geog</span></td>
                                <td><input type="text" name="higher_geog" title="HIGHER_GEOG" class="reqdClr" id="higher_geog" value="#higher_geog#" size="75"
									onchange="getGeog('nothing',this.id,'dataEntry',this.value)"></td>
                            </tr>
                            <tr>
                                <td align="right"><span class="f11a">Spec&nbsp;Locality&nbsp;</span></td>
                                <td nowrap="nowrap"><input type="text" name="spec_locality" title="SPEC_LOCALITY" class="reqdClr"
									id="spec_locality"	value="#stripQuotes(spec_locality)#" size="75"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="verbatim_date" title="VERBATIM_DATE" class="reqdClr" value="#verbatim_date#" id="verbatim_date" size="14">
                                    <span class="infoLink"
                                    ...
                                    <span class="infoLink" onclick="copyAllDates('ended_date');">Copy2All</span></td>
                            </tr>
                            <tr>
        ...
        onchange="getAgent('nothing',this.id,'dataEntry',this.value);"
                            ...
                            <cfloop from="1" to="12" index="i">
                                <tr id="d_part_name_#i#">
                                    ...
                                    <td><input type="text" name="part_container_unique_id_#i#" id="part_container_unique_id_#i#" value="#evaluate("data.part_container_unique_id_" & i)#"
									 size="20" onchange="part_container_name_#i#.className='reqdClr';setPartLabel(this.id);"></td>
                                    <td><!---         <textarea id="part_remark_#i#" value="#evaluate("data.part_remark_" & i)#" name="part_remark_#i#" size="100"></textarea>--->
                                        
                                        <input type="text" name="part_remark_#i#" id="part_remark_#i#"
									value="#stripQuotes(evaluate("data.part_remark_" & i))#" size="80"></td>
                                    <!---START Part Attribute Stuff --->
                                    <td><a class="part_att_btn" id="showDialog_#i#"><span style="font-size: 13px;">+</span></a> 
                ...
                <tr>
                    <td colspan="2"><table width="100%" class="bottom_band">
                            <tr>
                                <td width="16%"><span id="theNewButton" style="display:none;">
                                ...
                                <td width="16%"><span id="enterMode" style="display:none;">
                                    <input type="button"
                                ...
                                <td width="16%" nowrap="nowrap"><span id="theSaveButton" style="display:none;">
                                ...
                                <td width="16%"><a href="userBrowseBulkedGrid.cfm?action=ajaxGrid">[ AJAX table ]</a></td>
                                <td align="right" width="16%" nowrap="nowrap"><span id="recCount">#whatIds.recordcount#</span> records <span id="browseThingy"> - Jump to 
